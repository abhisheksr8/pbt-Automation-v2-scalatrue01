package io.prophecy.pipelines.automationpbtno_v2scalatrue01

import io.prophecy.libs._
import io.prophecy.pipelines.automationpbtno_v2scalatrue01.config._
...
import io.prophecy.pipelines.automationpbtno_v2scalatrue01.graph._
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/AutomationPBTNo_v2-scalatrue01"
    )
